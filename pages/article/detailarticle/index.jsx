...
//               >
//                 <span className="HammersmithOne" style={{ fontSize: 24 }}>
//                   Lorem ipsum dolor sit amet,mconsectetur adipiscing elit.
//                 </span>
//               </div>
//               <div
//                 style={{
...
//                     <span className="PTSans" style={{ fontSize: 18 }}>
...
//           <div
//             style={{ background: "#bfbfbf", width: "100%", minHeight: 400 }}
//           ></div>
...
//       <div style={{ width: "100%", minHeight: "100px", padding: "0px 10%" }}>
...
//                               {article?.author || "by Duckdumber"}
//                             </a>
//                           </p>
//                         </div>
//                         <time
//                           dateTime={article?.date || "2020-03-16"}
//                           className="text-gray-500"
//                         >
//                           {article?.date || "Mar 16, 2020"}
//                         </time>
//                       </div>
//                     </div>
//                     <div
...
//         {/* Konten statis lainnya tetap seperti sebelumnya */}
//         <div style={{ marginTop: 30 }}>
//           <div
//             style={{ background: "#bfbfbf", width: "100%", minHeight: 400 }}
//           ></div>
  ...
  return (
    <div>
      ...
      <div style={{ width: "100%", minHeight: "100px", padding: "0px 10%" }}>
        <div style={{ marginTop: 125 }}>
          <div>
            <h1 className="HammersmithOne" style={{ fontSize: 32 }}>
              {article.title}
            </h1>
            <p className="text-gray-500" style={{ marginTop: 8 }}>
              by {article.author} |{" "}
            ...
            <div style={{ marginTop: 32 }}>
              <p style={{ fontSize: 16, lineHeight: 1.8 }}>{article.content}</p>
            </div>
          </div>
        </div>

        {/* Comment / Like / Share Section */}
        <div style={{ marginTop: 50 }}>
          <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-2 xl:gap-x-8">
            {/* Example Comment */}
            <div style={{ width: "100%", minHeight: 100 }}>
              <div style={{ display: "flex" }}>
                <FontAwesomeIcon color="#000000" size="lg" icon={faComment} />
                <span
                  className="HammersmithOne"
                  style={{ fontSize: 16, marginLeft: 8 }}
                >
            ...
            {/* Add more comment blocks as needed */}
          </div>
        </div>
      </div>
